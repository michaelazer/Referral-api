...
let default_notifications = async function(campaign_id) {
    let templates = [
        ...
        subject:"Alpherral password reset",
        model:"participant",
        send_email:true
    },
    {name:"participant_invitation",
        ...
        message:`Hello there, \r\nYou have been invited to use the [[_company_name]] Alpherral System. From <a href='${process.env.FRONTEND_URL}'>here</a> you can manage your campaigns, and see other campaign options. Please click the link to begin user <a href='[[url]]'>registration</a>.`,
        subject:"Alpherral Invitation!",
        model:"participant",
        send_email:true
    },
    {name:"participant_suspension",
        ...
        campaign_id: campaign_id,
        message:`Your Alpherral account has been suspended. Please contact your service provider and check the state of your <a href='${process.env.FRONTEND_URL}/profile'>account</a>.`,
        subject:"Alpherral Account Suspended",
        model:"participant",
        send_email:true
    },
    {name:"participant_approval",
        ...
        campaign_id: campaign_id,
        message:`Your Alpherral account has been approved. You can now login to your <a href='${process.env.FRONTEND_URL}/profile'>account</a> and start sharing your referral links.`,
        subject:"Alpherral Account Approved",
        model:"participant",
        send_email:true
    },
    {name:"admin_new_sale",
